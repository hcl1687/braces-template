...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _lifecycle = __webpack_require__(15);
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  exports.warn = _warn = function warn(msg, vm) {
	    if (hasConsole && !_config2.default.silent) {
	      var res = '[Vue warn]: ' + msg + (vm ? formatComponentName(vm) : '');
	      _warn.msg = res;
	      console.error(res);
	    }
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Directive.prototype._teardown = function () {
	  if (this._bound) {
	    ...
	    if (process.env.NODE_ENV !== 'production' && this.el) {
	      (0, _index.arrRemove)(this.el._vue_directives, this);
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _compile = __webpack_require__(20);

	var compile = _interopRequireWildcard(_compile);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	exports.default = _extends({}, compile);
	module.exports = exports['default'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _for = __webpack_require__(25);
	...
	var _bind = __webpack_require__(32);

	var _bind2 = _interopRequireDefault(_bind);

	var _el = __webpack_require__(33);

	var _el2 = _interopRequireDefault(_el);

	var _cloak = __webpack_require__(34);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _priorities = __webpack_require__(28);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fragment = __webpack_require__(27);
	  ...
	  bind: function bind() {
	    ...
	    if (tokens) {
	      if (disallowedInterpAttrRE.test(attr) || attr === 'name' && (tag === 'PARTIAL' || tag === 'SLOT')) {
	        process.env.NODE_ENV !== 'production' && (0, _index.warn)(attr + '="' + descriptor.raw + '": ' + 'attribute interpolation is not allowed in Vue.js ' + 'directives and special attributes.', this.vm);
	        this.el.removeAttribute(attr);
	        this.invalid = true;
	      }
